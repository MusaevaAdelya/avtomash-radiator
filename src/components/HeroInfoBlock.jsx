...
function HeroInfoBlock() {
  return (
      <div className=" max-w-[691px] mx-auto flex flex-col items-center mt-14 mb-16">
          <h1 className="text-[28px] md:text-[56px] flex items-center font-bold uppercase text-center">
              <img className="w-auto h-14 m-3" src="/images/logo_1.jpg" alt="Logo"/>
              JSK BASHAT</h1>
          ...
          <div className="flex gap-2 mt-8 md:gap-4">
              <Button isLink={true} to={"/products"}
                      styleClasses=" py-2.5 px-8 bg-primary text-sm md:text-base lg:text-lg text-white font-medium rounded-full flex items-center justify-center">
                  Купить
              </Button>
              <Button isLink={true} to={"/products"}
                      styleClasses="flex items-center rounded-full py-2.5 px-4 md:px-8 text-dark-100 font-medium border border-dark-100 justify-center">
