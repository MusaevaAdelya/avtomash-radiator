...
function ProductListPage() {
  ...
  console.log(
    `ProductListPage: isProductsError - ${isProductsError}, isCategoriesError - ${isCategoriesError}`
  );

  console.log(
    `ProductListPage: isCategoriesLoading - ${isCategoriesLoading}, isProductsLoading - ${isProductsLoading}`
  );

  return (
    <>
      {(isProductsLoading || isCategoriesLoading) && <div>loading</div>}
      {products &&
        selectedCategory &&
        !isProductsLoading &&
        !isProductsError &&
