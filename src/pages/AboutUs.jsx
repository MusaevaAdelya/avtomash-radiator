    ...
    <section className="mt-6 md:mt-20 ">
      ...
      <div className="flex flex-col items-stretch justify-between my-24 gap-9 lg:flex-row">
        <div className="space-y-8">
          ...
          <ParagraphBlock
            title="Наши услуги"
            text="Мы предоставляем широкий ассортимент сельскохозяйственной техники в лизинг и даем гарантию на продукцию на один год. Наши товары поступают из Китая, Турции и Европы, что гарантирует разнообразие и высокое качество предлагаемых решений."
          />
        </div>
